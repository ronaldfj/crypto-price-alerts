...
def backtest_symbol(
    ...
    entry_full = data_source.fetch_klines_range(symbol, ENTRY_TIMEFRAME, range_start - 7 * 86400, now_ts)
    ...
    # Walk-forward: train_idx_max separa in-sample de out-of-sample.
    total_steps = end_idx - start_idx
    train_idx_max = start_idx + int(total_steps * TRAIN_FRACTION)
